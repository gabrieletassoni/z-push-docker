...
define('AUTODISCOVER_IMAP_SERVER', 'imap.example.com');
define('AUTODISCOVER_IMAP_PORT', 993);
define('AUTODISCOVER_IMAP_SSL', true);

define('AUTODISCOVER_SMTP_SERVER', 'smtp.example.com');
...
define('AUTODISCOVER_ACTIVESYNC_URL', 'https://activesync.example.com/Microsoft-Server-ActiveSync');

// Optional: Configure additional settings or domains if required
define('AUTODISCOVER_DEFAULT_EMAIL_DOMAIN', 'example.com');
