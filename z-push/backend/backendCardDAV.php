...
// Server name
define('CARDDAV_SERVER', '192.168.121.106');

// Server port
define('CARDDAV_PORT', '25555');
...
//   Add the trailing /
https://contacts.alchemic.it/carddav/gabrieletassoni@ldap.alchemic.it/aa0a3b56-0480-4958-bd18-a23e7531d706
define('CARDDAV_PATH', '/carddav/%u@%d/');
...
// %d: replaced with the domain
//   Add the trailing /
define('CARDDAV_DEFAULT_PATH', '/carddav/%u@%d/aa0a3b56-0480-4958-bd18-a23e7531d706/');
