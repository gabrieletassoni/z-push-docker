...
// settings for https://contacts.alchemic.it/carddav/gabrieletassoni@ldap.alchemic.it/aa0a3b56-0480-4958-bd18-a23e7531d706

// Server protocol: http or https
define('CARDDAV_PROTOCOL', 'https');

// Server name
define('CARDDAV_SERVER', 'contacts.alchemic.it');
...
// %d: replaced with the domain
//   Add the trailing /
define('CARDDAV_DEFAULT_PATH', '/carddav/%u/default/');
...
// %d: replaced with the domain
//  Add the trailing /
define('CARDDAV_GAL_PATH', '/carddav/%d/GAL/');
